...
train_proto = 'example/8_class_haitech_prototxt/MobileNetSSD_train.prototxt'  
train_model = 'snapshot/mobilenet_iter_3000.caffemodel'  #should be your snapshot caffemodel

deploy_proto = 'example/8_class_haitech_prototxt/MobileNetSSD_deploy.prototxt'  
save_model = 'MobileNetSSD_8_classes_haitech_deploy.caffemodel'
